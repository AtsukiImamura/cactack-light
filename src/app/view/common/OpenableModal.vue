<template>
  <div class="openable-modal">
    <div class="disp" @click="open">
      <slot></slot>
    </div>
...
@Component
export default class OpenableModal extends Vue {
